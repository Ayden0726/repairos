...
| `rebuild-client.ps1` | Wipe local data, verify ServerConnect initial page, build 1.2.7, extract, launch (ASCII + UTF-8 BOM) |
...
- `WorkshopOS-Setup-1.2.7.exe` — Inno installer (when ISCC is found)
